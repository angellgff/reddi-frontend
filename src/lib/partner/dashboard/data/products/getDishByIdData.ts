...
import { CreateProductFormState } from "@/src/lib/partner/productTypes";
import { API_DELAY } from "@/src/lib/type";
import { cache } from "react";

const mockDishes: Array<{ id: string; dish: CreateProductFormState }> = [
  {
    id: "1",
    dish: {
      image: "/tacos.svg",
