...
export default function PartnerAccordionItem({
  ...
  const discount = partner.id.charCodeAt(0) % 3 === 0 ? "10% off en RD$3,500+" : null;

  return (
    <div className="border-b border-gray-100 last:border-0 py-4">
      {/* Header Row */}
      <div className="flex items-center justify-between px-4 pb-2" onClick={onToggle}>
            ...
            {partner.products?.length > 0 ? (
                <div className="flex gap-4 pr-4">
                    {partner.products.map(product => (
                        <div key={product.id} className="min-w-[140px] w-[140px] flex flex-col items-center">
                            {/* Product Card */}
                     ...
                     {/* View More Link Card */}
                     <Link href={partner.href} className="min-w-[100px] flex flex-col items-center justify-center gap-2 text-gray-500">
                ...
                <div className="px-4 text-sm text-gray-500 py-2">
                    ...
                    <Link href={partner.href} className="text-emerald-600 ml-1 font-medium underline">
                        Ver tienda
                    </Link>
                </div>
            )}
