...
export default function DriverFloatingBar({ mode, amount, onAction, disabled }: Props) {
  // Handlers for slide
          ...
          {mode === "slide_complete" && (
            ...
            >
               ...
               <div className="absolute inset-0 flex items-center justify-center z-0">
                  <span className="text-white font-bold text-[16px]">Desliza al completar la entrega</span>
               </div>
          ...
          {mode === "proceed_pay" && (
             ...
             >
                ...
                <span className="font-bold text-[16px]">
                    RD${amount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || "0.00"}
                </span>
             </motion.button>
          )}
