...
export default function DeliveryCollectionModal({
  ...
  const [selectedMethod, setSelectedMethod] = useState<"cash" | "physical_pos">(
    initialMethod === "cash" || initialMethod === "physical_pos"
      ? initialMethod
      : "cash",
  );
  ...
  return (
    // IMPORTANTE: En Headless UI v2, Dialog con la prop 'transition'
    // maneja toda la animación. No uses <Transition> externo.
    <Dialog
      open={isOpen}
      onClose={onClose}
      transition
    ...
    >
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          <DialogPanel
            transition
            className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition duration-300 ease-out data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[closed]:sm:translate-y-0 data-[closed]:sm:scale-95 sm:my-8 sm:w-full sm:max-w-lg w-full"
          >
            {/* Header */}
            <div className="bg-emerald-600 px-4 py-6 text-center text-white relative">
              ...
              <DialogTitle
                as="h3"
                className="text-base font-semibold leading-6 text-emerald-100"
              >
                Total a Cobrar
              </DialogTitle>
                    ...
                    <div className="flex">
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-yellow-700">
                          <p>
                            Recibe el dinero antes de confirmar. Este monto se
                            sumará a tu deuda pendiente.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-blue-700">
                          <p>
                            Asegúrate de que la transacción fue{" "}
                            <strong>APROBADA</strong> en el datáfono antes de
                            continuar.
                          </p>
                        </div>
                      </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                disabled={loading}
                className="inline-flex w-full justify-center rounded-md bg-emerald-600 px-3 py-4 text-sm font-semibold text-white shadow-sm hover:bg-emerald-50 sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
